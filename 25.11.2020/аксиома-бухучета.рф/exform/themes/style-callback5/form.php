...
<div class="exform_wrapper style-callback5">
 ...
 <div class="form-body">
  ...
  <div class="mf_submit"><input onclick="ym(25084454, 'reachGoal', 'zvonok'); return true;" type="submit" class="send_btn" value="<?php echo $config->submit_title;?>"></div>
   </div>
  
  
  <div class="exform_addmsg">Нажимая кнопку, я принимаю <a target="_black" href="http://xn----7sbabeyrptt5atla3a7a.xn--p1ai/privacy_policy.pdf">соглашение о конфиденциальности</a> и соглашаюсь с обработкой персональных данных</div>
