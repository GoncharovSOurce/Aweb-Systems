...
<div class="exform_wrapper callbackNormal callback brdrad7" style="display: block">
 ...
 <form name="exform">
  <div class="inpt_wrpr">
   ...
   <textarea name="mf_phone_time" value="<?php echo $field_value["phone_time"];?>" class="<?php echo $field_class["phone_time"];?>" placeholder="<?php echo $config->phone_time_title;?>" /></textarea>
 
   
	<!--input type="checkbox" id="checkBoxId">
	<label for="checkBoxId" class="lab">- <?php echo $config->checbox_name;?></label-->
   <?php if($config->enable_captcha) : ?>
   <div class="exf_captcha" style="display: block">
  ...
  <?php endif; ?>
    ...
    <div class="mf_clear"></div>
  <div class="exform_addmsg">Нажимая кнопку, я принимаю <a href="https://drovaberesta.ru/privacy-policy">соглашение о конфиденциальности</a> и соглашаюсь с обработкой персональных данных</div>
