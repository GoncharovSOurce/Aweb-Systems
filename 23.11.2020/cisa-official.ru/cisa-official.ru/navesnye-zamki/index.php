...
<head>
    ...
    <title>Навесные замки Cisa купить в Москве по доступным ценам </title>
  <meta name="description" content="В нашей компании Вы можете купить навесные замки Cisa (Чиза) а также заказать сервис, ремонт, вскрытие и другие услуги по доступным ценам в Москве.">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-1 col-md-6 col-md-offset-1">
                <div class="main-crumbs">
                    <a href="/">Главная</a>Навесные замки Cisa
                </div>
...
<div class="price_flex">
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28350.73</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 5 070 р.</p>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28.553.62</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 5 070 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28053-55</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 3 583 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28053-56</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 4 056 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28053-57</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 4 124 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28.053-70</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 5 070 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28.053-72</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span>5 070 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image081.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 28.053-71</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 5 070 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.20</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 312 р</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>  
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.25</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 312 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.30</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 312 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    ...
    <h4>Замок навесной Cisa LOGO LINE 21010.30</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 385 р</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.50</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 385 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.60</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 400 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image089.png" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21010.70</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 416 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>

  <div class="price_flex1">
    <img src="/img/skin/image093.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21011.30</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 462 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image093.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21011.40</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 493 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>
  ...
  <div class="price_flex1">
    <img src="/img/skin/image093.jpg" alt="">
    <h4>Замок навесной Cisa LOGO LINE 21011.50</h4>
    <div class="price_flex2">
      <p class="price-item__price"><span>=</span> 508 р.</p>
      <button class="cta-btn popup-open"><span>Купить</span></button>
    </div>
  </div>  
</div>
