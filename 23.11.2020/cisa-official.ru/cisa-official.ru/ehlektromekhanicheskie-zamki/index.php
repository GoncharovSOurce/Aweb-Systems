...
<head>
    ...
    <title>Электромеханический замок Cisa купить в Москве по доступным ценам</title>
	<meta name="description" content="В нашей компании Вы можете купить электромеханические замки Cisa (Чиза) а также заказать сервис, ремонт, вскрытие и другие услуги по доступным ценам в Москве.">
...
<section class="pad_70" id="main">
    ...
    <div class="container">
        <div class="row main-cont">
            <div class="col-xs-12">
                <h1>Электромеханические замки Cisa</h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-1 col-md-6 col-md-offset-1">
                <div class="main-crumbs">
                    <a href="/">Главная</a>Электромеханические замки Cisa
                </div>
...
<div class="price_flex">
	...
	<div class="price_flex1">
		<img src="/img/skin/9.png" alt="">
		<h4>Замок Cisa 1A731</h4>
		<div class="price_flex2">
			<p class="price-item__price"><span>=</span> 8 000 р.</p>
			<button class="cta-btn popup-open"><span>Купить</span></button>
		</div>
	</div>
